...
interface CustomizationOptions {
  types: string[];
  styles: string[];
  skinTones: { name: string; value: string }[];
  hairColors: { name: string; value: string }[];
  bodyTypes: string[];
  expressions: string[];
  poses: string[];
}

export default function UniversalCharacterPage() {
  ...
  const characterRefs = useRef<{[key: string]: any}>({});

  // Sample character data
  const sampleCharacters: CharacterConfig[] = [
    {
  ...
  const handlePlayAnimation = (characterId: string, animation: string) => {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-purple-100 to-blue-100 flex items-center justify-center">
        <div className="text-center">
          <div className="text-2xl font-bold text-gray-800 mb-4">Loading Universal Character Library...</div>
