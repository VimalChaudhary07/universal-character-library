/**
 * Sporty Girl Character
 * 
 * An energetic girl in sporty attire, great for fitness apps and active content.
 * 
 * @module SportyGirl
 * @version 1.0.0
...
/**
 * Sporty Girl Character Class
 */
class SportyGirl {
  /**
   * Create a new Sporty Girl character instance
   ...
   * @param {string} options.colors.shirt - Sport shirt color
   * @param {string} options.colors.pants - Sport pants color
   * @param {string} options.colors.shoes - Sport shoes color
  ...
  constructor(options = {}) {
    ...
    this.options = {
      ...
      colors: {
        ...
        hair: options.colors?.hair || '#FFD700',
        shirt: options.colors?.shirt || '#FF69B4',
        pants: options.colors?.pants || '#000080',
        shoes: options.colors?.shoes || '#FFFFFF'
      },
...
// Static methods
SportyGirl.getMeta = () => meta;
SportyGirl.getAvailableAnimations = () => meta.animations.map(anim => anim.name);
SportyGirl.getDefaultColors = () => ({
  skin: '#FDBCB4',
  hair: '#FFD700',
  shirt: '#FF69B4',
  pants: '#000080',
